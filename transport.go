...
func (t *transport) recoveryResult(lost int64, blocked bool, cause error) error {
	if lost > 0 {
		return &recoveryOutcomeError{
			Lost: lost, Blocked: blocked, Cause: cause, reported: t.onRecoveryProgress != nil,
		}
	}
	return cause
}
